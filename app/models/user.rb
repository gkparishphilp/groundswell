class User < ActiveRecord::Base #SwellUsers::User
	...
	has_many 	:providers, through: :client_relationships

	has_many 	:supporter_relationships
	has_many 	:supporters, through: :supporter_relationships

	has_many 	:assignments
	has_many 	:assigned_stats
	has_many	:assigned_activities
	#has_many 	:assigned_activities, through: :assignments, source: :assigned, source_type: 'AssignedActivity'
	#has_many	:assigned_stats, through: :assignments, source: :assigned, source_type: 'AsignedStat'
